...
part of 'authors_view_event.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthorsViewEvent);
}
...
/// @nodoc
class $AuthorsViewEventCopyWith<$Res>  {
$AuthorsViewEventCopyWith(AuthorsViewEvent _, $Res Function(AuthorsViewEvent) __);
}


/// Adds pattern-matching-related methods to [AuthorsViewEvent].
extension AuthorsViewEventPatterns on AuthorsViewEvent {
...
class Init extends AuthorsViewEvent {
  const Init(): super._();
...
class QueryChanged extends AuthorsViewEvent {
  const QueryChanged(this.query): super._();
  

 final  String query;

/// Create a copy of AuthorsViewEvent
...
@override
String toString() {
  return 'AuthorsViewEvent.queryChanged(query: $query)';
}
...
/// @nodoc
abstract mixin class $QueryChangedCopyWith<$Res> implements $AuthorsViewEventCopyWith<$Res> {
